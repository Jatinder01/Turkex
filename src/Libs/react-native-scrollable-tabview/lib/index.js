          ...
          {this.props.showCustomHeader && (
            <View
              ...
              <TouchableOpacity
                ...
                onPress={this.props.nameButtonClicked}>
                {this.props.nameButtonSelected ? (
                  this.props.nameSelected ? (
                    <Text style={{marginLeft: 10}}>
                      {/* Name ↓ <Text style={{color: 'grey'}}>/ Vol</Text> */}
                    </Text>
                  ) : (
                    <Text style={{color: 'grey', marginLeft: 10}}>
                      {/* Name / <Text style={{}}>Vol ↓</Text> */}
                    </Text>
                  )
                ) : (
                  <Text style={{color: 'grey', marginLeft: 10}}>
              ...
              <TouchableOpacity
                ...
                onPress={this.props.lastPriceButtonClicked}>
                {this.props.priceButtonSelected ? (
                  this.props.priceSelected ? (
                    <Text style={{}}>{/* Last Price ↑ */}</Text>
                  ) : (
                    <Text style={{}}>{/* Last Price ↓ */}</Text>
                  )
                ) : (
              ...
              <TouchableOpacity
                ...
                onPress={this.props.hourButtonClicked}>
                {this.props.hourButtonSelected ? (
                  this.props.hourSelected ? (
                    <Text style={{marginRight: 10}}>{/* 24h Chg% ↑ */}</Text>
                  ) : (
                    <Text style={{marginRight: 10}}>{/* 24h Chg% ↓ */}</Text>
                  )
                ) : (
