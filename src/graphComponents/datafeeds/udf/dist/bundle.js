(function(global, factory) {
    ...
    HistoryProvider.prototype.getBars = function(
      ...
      return new Promise(function(resolve, reject) {
        _this._requester
          .sendRequest(
            _this._datafeedUrl,
            symbolInfo.name.split('/').join('').toLowerCase() + "/k-line",
            requestParams
          )
          .then(function(response) {
            ...
            _this._history[market] = { lastBar: lastBar };
  ...
  var UDFCompatibleDatafeedBase = /** @class */ (function() {
    function UDFCompatibleDatafeedBase(
      ...
      // this._configurationReadyPromise = this._setupWithConfiguration(defaultConfiguration());
    ...
    UDFCompatibleDatafeedBase.prototype.onReady = function(callback) {
      ...
      setTimeout(() => callback(_this._configuration), 0);
    };
    ...
    UDFCompatibleDatafeedBase.prototype.resolveSymbol = function(
      ...
      var split_symbol = symbolName.split(/[:]/);
      var length = split_symbol.length - 1;
      var market = split_symbol[length];
      var exchange = split_symbol[length - 1];
  ...
  var Requester = /** @class */ (function() {
    ...
    Requester.prototype.sendRequest = function(datafeedUrl, urlPath, params) {
      ...
      var options = {
        credentials: "include",
        origin: "https://staging-documents-rubyex.s3-us-west-2.amazonaws.com/"
      };
